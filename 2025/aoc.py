...
class Pos(tuple):
    def __new__(self, *arg):
        return tuple.__new__(Pos, arg)

    def __add__(self, other):
        if len(self) == len(other):
            return Pos(*(a + b for a, b in zip(self, other)))
    ...
    def __eq__(self, o):
        return len(self) == len(o) and all(a == b for a, b in zip(self, o))
